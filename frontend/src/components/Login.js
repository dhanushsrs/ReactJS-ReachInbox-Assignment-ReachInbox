...
const Login = () => {
    ...
    const handleLogin = () => {
        window.location.href = 'https://hiring.reachinbox.xyz/api/v1/auth/google-login?redirect_to=https://reactjs-reachinbox-assignment-reachinbox-ddsg.onrender.com';
    };
